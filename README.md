...
## Dataset Used             
Source: Morgan Stanley Financial Transactional Data (simulated dataset provided for this training project). Contains 800 transactions across 8 customers/accounts, spanning January 2023 to June 2024, covering transaction type, amount, account balance, risk score, credit rating, and account tenure.            
